...
class ESP8266S {
 public:
    ...
    ESP8266S(SoftwareSerial &uart, uint32_t baud = 115200);
#elif (USER_SEL_VERSION == VERSION_18)
    ESP8266S(SoftwareSerial &uart, uint32_t baud = 9600);
     ...
     */
#if (USER_SEL_VERSION == VERSION_22)
    ESP8266S(HardwareSerial &uart, uint32_t baud = 115200);
#elif (USER_SEL_VERSION == VERSION_18)
    ESP8266S(HardwareSerial &uart, uint32_t baud = 9600);
#endif /* #if(USER_SEL_VERSION == VERSION_22) */
