...
float interruptionRead(int m_i)
    {
        ...
        if (time_last == 1000)
          {
              field_value_i = 0;
              Serial.println(F("bucle if time_last = 1000"));
              Serial.print(F("time_last: "));
              Serial.println(time_last);   
          }
          
        else if ((time_0 - time_last) > 18000000) 
          {
              field_value_i = 0;
              Serial.println(F("time_0 - time_last"));
          ...
          {
              field_value_i = float(time_0 -time_last);
              Serial.println(F("time_dif < time_0 - time_last"));
